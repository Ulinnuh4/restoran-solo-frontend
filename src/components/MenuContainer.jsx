    ...
    <Box sx={{ flexGrow: 1 }}>
      <Grid container spacing={2} paddingY={3} style={{ alignItems: "center", justifyContent: "center" }}>
        <Grid item md={2} xs={6} sm={6}>
          <CustomButton isactive={activeButton === "all"} onClick={() => handleClick("all")}>
            All
          </CustomButton>
        </Grid>
        <Grid item md={2} xs={6} sm={6}>
          <CustomButton isactive={activeButton === "pembuka"} onClick={() => handleClick("pembuka")}>
            Pembuka
          </CustomButton>
        </Grid>
        <Grid item md={2} xs={6} sm={6}>
          <CustomButton isactive={activeButton === "utama"} onClick={() => handleClick("utama")}>
            Utama
          </CustomButton>
        </Grid>
        <Grid item md={2} xs={6} sm={6}>
          <CustomButton isactive={activeButton === "penutup"} onClick={() => handleClick("penutup")}>
            Penutup
          </CustomButton>
        </Grid>
      </Grid>
